...
const log = logger.child({ module: "ble" });
...
async function connectCapacitor(deviceId?: string): Promise<void> {
  ...
  log.info({}, "Notifications started — ready");
}
