...
describe("ticTacToePickTarget", () => {
  ...
  it("picks the winning cell to complete a row", () => {
    const owner: (0 | 1 | null)[] = [0, 0, null, null, null, null, null, null, null];
  ...
  it("blocks opponent win", () => {
    const owner: (0 | 1 | null)[] = [1, 1, null, null, null, null, null, null, null];
    const result = ticTacToePickTarget(defaultGrid, owner, 0, emptyMarks);
  ...
  it("prefers center on empty board", () => {
    const result = ticTacToePickTarget(defaultGrid, [...emptyOwner], 0, emptyMarks);
  ...
  it("uses opponentMarks for tiebreaking between equal cells", () => {
    ...
    const owner: (0 | 1 | null)[] = [null, null, null, null, 0, null, null, null, null];
    const opponentMarks = [0, 0, 5, 0, 0, 0, 0, 0, 0];
    const result = ticTacToePickTarget(defaultGrid, owner, 0, emptyMarks, opponentMarks);
  ...
  it("picks winning cell for player 1", () => {
    ...
    const owner: (0 | 1 | null)[] = [0, 0, null, null, 1, null, null, null, null];
  ...
  it("chooses a corner over an edge on a board with center taken", () => {
    ...
    const owner: (0 | 1 | null)[] = [null, null, null, null, 1, null, null, null, null];
    const result = ticTacToePickTarget(defaultGrid, owner, 0, emptyMarks);
