...
> **get** `protected` **gameTypeName**(): `string`
...
[`BaseGameRoom`](../../BaseGameRoom/classes/BaseGameRoom.md).[`gameTypeName`](../../BaseGameRoom/classes/BaseGameRoom.md#gametypename)
...
Defined in: [apps/server/src/rooms/X01Room.ts:75](https://github.com/keenanlk/granboard-client/blob/main/apps/server/src/rooms/X01Room.ts#L75)
...
> `protected` **extractPlayerGameStats**(`state`, `playerIndex`): `object`

Defined in: [apps/server/src/rooms/X01Room.ts:43](https://github.com/keenanlk/granboard-client/blob/main/apps/server/src/rooms/X01Room.ts#L43)
...
[`BaseGameRoom`](../../BaseGameRoom/classes/BaseGameRoom.md).[`extractPlayerGameStats`](../../BaseGameRoom/classes/BaseGameRoom.md#extractplayergamestats)
...
[`RoomCreateOptions`](../../BaseGameRoom/interfaces/RoomCreateOptions.md)
