...
import { WebPlugin } from "./chunk-PT3A4N6G.js";
...
var BluetoothLeWeb = class extends WebPlugin {
  ...
  onAdvertisementReceived(event) {
    ...
    if (
      ...
      const result = {
        ...
        uuids:
          (_b = event.uuids) === null || _b === void 0
            ? void 0
            : _b.map(webUUIDToString),
      };
  ...
  async writeWithoutResponse(options) {
    ...
    await (characteristic === null || characteristic === void 0
      ? void 0
      : characteristic.writeValueWithoutResponse(dataView));
  }
  ...
  async writeDescriptor(options) {
    ...
    await (descriptor === null || descriptor === void 0
      ? void 0
      : descriptor.writeValue(dataView));
  }
...
export { BluetoothLeWeb };
//# sourceMappingURL=web-J3KFB53V.js.map
