  ...
  return (
    <div className="absolute inset-0 z-20 bg-zinc-950/95 flex flex-col items-center justify-center gap-4">
      ...
      <p
        ...
        style={{ fontFamily: "Beon, sans-serif", color: "var(--color-game-accent)", textShadow: "0 0 20px var(--color-game-accent), 0 0 60px var(--color-game-accent), 0 0 100px var(--color-game-accent-glow)" }}
      >
        {countdown}
      </p>
      {nextPlayerName && (
        <p
          className="text-2xl font-normal shrink-0"
          style={{ fontFamily: "Beon, sans-serif", color: "var(--color-game-accent)", textShadow: "0 0 15px var(--color-game-accent), 0 0 40px var(--color-game-accent-glow)" }}
        >
