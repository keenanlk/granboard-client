...
[Documentation](../../../../../../README.md) / [@nlc-darts/engine](../../../../README.md) / [src/engine/cricket.types.ts](../README.md) / emptyMarks
...
`Record`\<[`CricketTarget`](../type-aliases/CricketTarget.md), `number`\>

A record mapping each CricketTarget to 0.
